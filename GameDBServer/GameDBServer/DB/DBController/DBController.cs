...
namespace GameDBServer.DB.DBController
{
    ...
    public abstract class DBController<T>
    {
        ...
        /// </summary>
        /// <param name="sql">sql语句</param>
        /// <param name="keyName">作为key的Field或Property名称</param>
        /// <returns>Dictionary形式的查询结果集</returns>
...
//                     if (columnName.Equals("nextRewardTime"))
//                     {
//                         System.Console.WriteLine(field.GetType());
//                         System.Console.WriteLine(columnValue.GetType());
