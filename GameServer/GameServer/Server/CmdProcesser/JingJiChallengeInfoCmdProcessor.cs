...
namespace GameServer.Server.CmdProcesser
{
    ...
    public class JingJiChallengeInfoCmdProcessor : ICmdProcessor
    {
        ...
        public bool processCmd(Logic.GameClient client, string[] cmdParams)
        {
            ...
            List<JingJiChallengeInfoData> dataList = Global.sendToDB<List<JingJiChallengeInfoData>>((int)TCPGameServerCmds.CMD_DB_JINGJICHANG_ZHANBAO_DATA, DataHelper.ObjectToBytes<int[]>(new int[] { roleId, pageIndex }));
