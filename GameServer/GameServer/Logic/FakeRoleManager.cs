...
namespace GameServer.Logic
{
    ...
    public static class FakeRoleManager
    {
        ...
        /// 删除指定类型的所有假人
        /// </summary>
        public static void ProcessDelFakeRoleByType(FakeRoleTypes fakeRoleType)
        {
            List<FakeRoleItem> fakeRoleItemList = GetFakeRoleListByType(fakeRoleType);
            foreach (var item in fakeRoleItemList)
            {
                ProcessDelFakeRole(item.FakeRoleID);
            }
        }
        ...
        /// 处理删除假人
        /// </summary>
        public static void ProcessDelFakeRole(int FakeRoleID)
        {
