...
namespace GameServer.Logic
{
    ...
    public class PopupWinMgr
    {
        ...
        /// 上次弹窗的天
        /// </summary>
        private static int LastPopupWinDay = DateTime.Now.DayOfYear;

        /// <summary>
        /// 上一次弹窗的时间记录
        /// </summary>
        private static PopupWinTimeItem LastPopupWinTimeItem = new PopupWinTimeItem() { Hour = DateTime.Now.Hour, Minute = DateTime.Now.Minute, };
