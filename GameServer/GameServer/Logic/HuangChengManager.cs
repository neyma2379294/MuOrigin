...
namespace GameServer.Logic
{
    ...
    public class HuangChengManager
    {
        ...
        /// 皇城战期间皇帝特效的保持时间
        /// </summary>
        private static long HuangDiRoleTicks = DateTime.Now.Ticks / 10000;
        ...
        public static void LoadHuangDiRoleIDFromDBServer(int bhid)
        {
            ...
            string[] fields = Global.ExecuteDBCmd((int)TCPGameServerCmds.CMD_DB_GETLEADERROLEIDBYBHID, string.Format("{0}", bhid));
        ...
        public static int ProcessTakeSheLiZhiYuan(int roleID, string roleName, string bhName, bool sendToOtherLine = true)
        {
            ...
            HuangDiRoleTicks = DateTime.Now.Ticks / 10000;
        ...
        private static void ProcessRoleBangGongAwards(GameClient client, bool success)
        {
            ...
            {
                //更新用户帮贡
                GameManager.ClientMgr.AddBangGong(Global._TCPManager.MySocketListener, Global._TCPManager.tcpClientPool, Global._TCPManager.TcpOutPacketPool, client, ref bangGong, AddBangGongTypes.None);
