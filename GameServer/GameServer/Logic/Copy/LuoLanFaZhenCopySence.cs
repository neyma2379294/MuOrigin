...
namespace GameServer.Logic
{
    ...
    class LuoLanFaZhenCopySence
    {
        ...
        /// 当前波要刷的怪物信息列表
        /// </summary>
        public List<LuoLanFaZhenCopySenceMonster> m_CreateWaveMonsterList = new List<LuoLanFaZhenCopySenceMonster>();
    ...
    /// 恶魔来袭副本怪物信息
    /// </summary>
    public class LuoLanFaZhenCopySenceMonster
    {
        /// <summary>
        /// ID
        /// </summary>
