...
namespace GameServer.Logic
{
    ...
    public class Monster : IObject
    {
        ...
        public void OnDead()
        {
            ...
            _LastDeadTicks = DateTime.Now.Ticks;
        ...
        {
            //30秒 无人攻击 后 无效
            if (DateTime.Now.Ticks / 10000 - _LastLogAttackerTicks > 30000)
            {
                lock (_AttackerDict)
                {
                    _AttackerDict.Clear();
        ...
        public void AddAttacker(int roleID, int injured)
        {
            lock (_AttackerDict)
            {
                _LastLogAttackerTicks = DateTime.Now.Ticks / 10000;
        ...
        public GActions Action
        {
            ...
            set
            {
                if (_Action != value)
                {
                    ...
                    _LastActionTick = DateTime.Now.Ticks / 10000;
                    if (value == GActions.Attack || value == GActions.Magic || value == GActions.Bow)
                    {
                        if (FrameCounter < EndFrame)
                        {
        ...
        private void BeginHeart()
        {
            ...
            LastMonsterLivingSlotTicks = DateTime.Now.Ticks / 10000;
        ...
        public virtual void Timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                // System.Console.WriteLine(string.Format("执行DoAction{0}：{1}:{2}", CurrentMagic, DateTime.Now.Ticks, Action));
                DoAction();
            }
            ...
            if (FrameCounter >= EndFrame && (_Action == GActions.Attack || _Action == GActions.Magic || _Action == GActions.Bow))
            {
                ...
                //{
                //    System.Diagnostics.Debug.WriteLine(string.Format("PreAttack {0}", DateTime.Now.Ticks / 10000 - LastAttackTicks));
                //}

                //LastAttackTicks = DateTime.Now.Ticks / 10000;

                //if (value == GActions.Attack || value == GActions.Magic || value == GActions.Bow)
                {
                    _LastAttackActionTick = DateTime.Now.Ticks / 10000;
                }
            ...
            else if (FrameCounter >= EndFrame && _Action == GActions.PreAttack) //如果是战斗待机状态，则转入战斗状态
            {
                ...
                //if (LastAttackTicks > 0)
                //{
                //    System.Diagnostics.Debug.WriteLine(string.Format("Attack {0}", DateTime.Now.Ticks / 10000 - LastAttackTicks));
                //}
        ...
        */
        ...
        private long LastMonsterLivingSlotTicks = DateTime.Now.Ticks / 10000;
        private long LastMonsterLivingTicks = DateTime.Now.Ticks / 10000;
        ...
        {
            return (DateTime.Now.Ticks / 10000 - LastMonsterLivingTicks);
        }
        ...
        public bool CanExecBossAI(BossAIItem bossAIItem)
        {
            ...
            lock (TriggerMutex)
            {
                ...
                if (bossAIItem.TriggerCD > 0)
                {
                    ...
                    if ((DateTime.Now.Ticks / 10000) - lastTicks < (bossAIItem.TriggerCD * 1000))
                    {
                        return false;
                    }
                }
        ...
        public bool RecBossAI(BossAIItem bossAIItem)
        {
            ...
            lock (TriggerMutex)
            {
                ...
                if (bossAIItem.TriggerCD > 0)
                {
                    TriggerCDDict[bossAIItem.ID] = (DateTime.Now.Ticks / 10000);
                }
            }
