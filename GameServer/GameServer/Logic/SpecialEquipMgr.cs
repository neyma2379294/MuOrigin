...
namespace GameServer.Logic
{
    ...
    public class SpecialEquipMgr
    {
        ...
        public static void DoEquipExtAttack(GameClient client, int categoriy, int enemy)
        {
            ...
            if (-1 != enemy)
            {
                ...
                else if (st == GSpriteTypes.Other)
                {
                    ...
                    if (null != enemyClient)
                    {
                        enemyClient.ClientData.DongJieStart = DateTime.Now.Ticks / 10000;
        ...
        public static void DoEquipRestoreBlood(GameClient client, int categoriy)
        {
            ...
            //判断是否处于冷却中,如果是则退出
            if ((cooldown * 1000) + client.ClientData.SpecialEquipLastUseTicks >= DateTime.Now.Ticks / 10000)
            {
                return;
            }
            ...
            //设置冷却时间
            client.ClientData.SpecialEquipLastUseTicks = DateTime.Now.Ticks / 10000;
