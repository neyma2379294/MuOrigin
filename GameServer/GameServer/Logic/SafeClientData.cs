...
namespace GameServer.Logic
{
    ...
    public class SafeClientData
    {
            ...
            set
            {
                lock (this)
                {
                    if (_CurrentAction != value)
                    {
                        ...
                        //{
                        //    _LastSiteExpTicks = DateTime.Now.Ticks / 10000; //开始计时
        ...
        private long _LastDBHeartTicks = DateTime.Now.Ticks / 10000; //如果不赋予初始值，会导致在线时长计算为负数?
        ...
        private long _LastSiteExpTicks = DateTime.Now.Ticks / 10000;
        ...
        */
        ...
        /// 标记客户端心跳的时间
        /// </summary>
        private long _LastClientHeartTicks = DateTime.Now.Ticks / 10000;
        ...
        /// 上次标记处理地图时间限制的时间(单位秒)
        /// </summary>
        private long _LastProcessMapLimitTimesTicks = DateTime.Now.Ticks / 10000;
        ...
        /// 计算登录次数的日ID
        /// </summary>
        private int _LoginDayID = DateTime.Now.DayOfYear;
        ...
        public int RoleIDAttackebByMyself
        {
            ...
            {
                //15秒后无效
                if (DateTime.Now.Ticks / 10000 - _LastLogRoleIDAttackebByMyselfTicks > 15000)
                {
                    return -1;
                }
            ...
            set 
            {
                _LastLogRoleIDAttackebByMyselfTicks = DateTime.Now.Ticks / 10000;
        ...
        public int RoleIDAttackMe
        {
            ...
            {
                //15秒后无效
                if (DateTime.Now.Ticks / 10000 - _LastLogRoleIDAttackMeTicks > 15000)
                {
                    return -1;
                }
            ...
            set 
            {
                _LastLogRoleIDAttackMeTicks = DateTime.Now.Ticks / 10000;
        ...
        /// </summary>
        private long _LastMapLimitUpdateTicks = DateTime.Now.Ticks / 10000;
        ...
        /// 上次提示用户更新客户端的时间
        /// </summary>
        private long _LastHintToUpdateClientTicks = DateTime.Now.Ticks / 10000;
        ...
        /// 物品使用限时更新时间
        /// </summary>
        private long _LastGoodsLimitUpdateTicks = DateTime.Now.Ticks / 10000;
        ...
        /// 角色上次死亡时间
        /// </summary>
        private long _LastRoleDeadTicks = DateTime.Now.Ticks / 10000;
        ...
        /// 冥想时间计时
        /// </summary>
        private long _MeditateTicks = DateTime.Now.Ticks / 10000;
        ...
        /// 图鉴属性值
        /// </summary>
        private PictureJudgeInfo _PictureJudgeProp = new PictureJudgeInfo();

        /// <summary>
        /// 图鉴属性值
        /// </summary>
        public PictureJudgeInfo PictureJudgeProp
        {
            get { return _PictureJudgeProp; }
        }
        ...
        /// <summary>
        /// 已经提交的图鉴类型计数信息--key-tpye value-count
        /// </summary>
        public Dictionary<int, int> _PictureJudgeReferTypeInfo = new Dictionary<int, int>();

        /// <summary>
        /// 已经提交的图鉴类型计数信息
        /// </summary>
        public Dictionary<int, int> PictureJudgeReferTypeInfo
        {
            get { return _PictureJudgeReferTypeInfo; }
            set { _PictureJudgeReferTypeInfo = value; }
        }
        ...
        #region 采集相关
        private long _CaiJiStartTick = 0;
        public long CaiJiStartTick
        {
