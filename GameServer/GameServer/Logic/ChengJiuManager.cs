...
//                 MergeData = (int)GetChengJiuExtraDataByField(client, ChengJiuExtraDataField.MergeData),
        ...
        public static void OnTongQianIncrease(GameClient client)
        {
            ...
            Global.SaveRoleParamsInt32ValueToDB(client, RoleParamName.MaxTongQianNum, client.ClientData.MaxTongQianNum);
        ...
        /// </summary>
        /// <returns></returns>
        public static void ProcessCompleteCopyMapForChengJiu(GameClient client, int nCopyMapLev)
        {
