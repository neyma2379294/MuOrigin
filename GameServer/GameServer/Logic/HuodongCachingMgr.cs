...
namespace GameServer.Logic
{
    ...
    public class KingActivity : Activity
    {
        ...
        protected bool GiveAwardByOccupation(GameClient client, AwardItem myAwardItem, int occupation)
        {
            ...
            if(myAwardItem.GoodsDataList!=null&&myAwardItem.GoodsDataList.Count>0)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (occupation == Global.GetGoodsToOccupation(data.GoodsID))
                    {
                        Global.AddGoodsDBCommand(Global._TCPManager.TcpOutPacketPool, client,
            ...
            if (Global.CanAddGoodsDataList(client, AwardDict[nBtnIndex].GoodsDataList))
            {
                ...
                if (AwardDict2.ContainsKey(nBtnIndex))
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        if (nOccu == Global.GetGoodsToOccupation(data.GoodsID))
        ...
        public override bool HasEnoughBagSpaceForAwardGoods(GameClient client)
        {
            ...
            if (Global.CanAddGoodsDataList(client, AwardDict2[maxKey].GoodsDataList))
            {
                ...
                lData.Add(AwardDict2[maxKey].GoodsDataList[nOccu]);
    ...
    public class MeiRiChongZhiActivity : Activity
    {
        ...
        public override bool HasEnoughBagSpaceForAwardGoods(GameClient client, Int32 nBtnIndex)
        {
            ...
            //判断背包空格是否能提交接受奖励的物品
            return Global.CanAddGoodsDataList(client, AwardDict[nBtnIndex].GoodsDataList);
        }
    };
       ...
       // public Dictionary<int, AwardItem> AwardDict2 = new Dictionary<int, AwardItem>();    // 职业奖励
        ...
        protected  new bool GiveAwardByOccupation(GameClient client, AwardItem myAwardItem, int occupation)
        {
            ...
            if(myAwardItem.GoodsDataList!=null&&myAwardItem.GoodsDataList.Count>0)
            {
                ...
                //添加物品
                Global.AddGoodsDBCommand(Global._TCPManager.TcpOutPacketPool, client,
                    myAwardItem.GoodsDataList[occupation].GoodsID, myAwardItem.GoodsDataList[occupation].GCount,
                    myAwardItem.GoodsDataList[occupation].Quality, "", myAwardItem.GoodsDataList[occupation].Forge_level,
                    myAwardItem.GoodsDataList[occupation].Binding, 0, "", true, 1,
                    GetActivityChineseName((ActivityTypes)ActivityType), Global.ConstGoodsEndTime, myAwardItem.GoodsDataList[occupation].AddPropIndex, myAwardItem.GoodsDataList[occupation].BornIndex, myAwardItem.GoodsDataList[occupation].Lucky, myAwardItem.GoodsDataList[occupation].Strong, myAwardItem.GoodsDataList[occupation].ExcellenceInfo, myAwardItem.GoodsDataList[occupation].AppendPropLev, myAwardItem.GoodsDataList[occupation].ChangeLifeLevForEquip);
            }
    ...
    public class HuodongCachingMgr
    {
        ...
        /// <returns></returns>
        private static List<GoodsData> ParseGoodsDataList(string[] fields, string fileName)
        {
            List<GoodsData> goodsDataList = new List<GoodsData>();
        ...
        public static int ProcessGetWLoginGift(GameClient client, int whichOne)
        {
            ...
            for (int i = 0; i < wLoginItem.GoodsDataList.Count; i++)
            {
                ...
                //添加物品
                Global.AddGoodsDBCommand(Global._TCPManager.TcpOutPacketPool, client,
                    wLoginItem.GoodsDataList[i].GoodsID, wLoginItem.GoodsDataList[i].GCount,
                    wLoginItem.GoodsDataList[i].Quality, "", wLoginItem.GoodsDataList[i].Forge_level,
                    wLoginItem.GoodsDataList[i].Binding, 0, "", true, 1, "周连续登录奖励", Global.ConstGoodsEndTime, wLoginItem.GoodsDataList[i].AddPropIndex, wLoginItem.GoodsDataList[i].BornIndex, wLoginItem.GoodsDataList[i].Lucky, wLoginItem.GoodsDataList[i].Strong);
            }
        ...
        public static int ProcessGetMOnlineTimeGift(GameClient client, int whichOne)
        {
            ...
            //获取奖励的物品
            GameManager.ClientMgr.AddUserGold(Global._TCPManager.MySocketListener, Global._TCPManager.tcpClientPool, Global._TCPManager.TcpOutPacketPool, client, mOnlineTimeItem.BindYuanBao);
        ...
        public static int ProcessGetNewStepGift(GameClient client, int step)
        {
            ...
            for (int i = 0; i < newStepItem.GoodsDataList.Count; i++)
            {
                ...
                //添加物品
                Global.AddGoodsDBCommand(Global._TCPManager.TcpOutPacketPool, client,
                    newStepItem.GoodsDataList[i].GoodsID, newStepItem.GoodsDataList[i].GCount,
                    newStepItem.GoodsDataList[i].Quality, "", newStepItem.GoodsDataList[i].Forge_level,
                    newStepItem.GoodsDataList[i].Binding, 0, "", true, 1, "新手见面奖品", Global.ConstGoodsEndTime, newStepItem.GoodsDataList[i].AddPropIndex, newStepItem.GoodsDataList[i].BornIndex, newStepItem.GoodsDataList[i].Lucky, newStepItem.GoodsDataList[i].Strong);
            }
            ...
            {
                //给用户加钱,更新用户的绑定元宝
                GameManager.ClientMgr.AddUserGold(Global._TCPManager.MySocketListener, Global._TCPManager.tcpClientPool, Global._TCPManager.TcpOutPacketPool, client, bindYuanBao);
                ...
                if (Global.CanAddGoodsDataList(client, newStepItem.GoodsDataList))
                {
                    ...
                    for (int i = 0; i < newStepItem.GoodsDataList.Count; i++)
                    {
                        ...
                        Global.AddGoodsDBCommand(Global._TCPManager.TcpOutPacketPool, client,
                            newStepItem.GoodsDataList[i].GoodsID, newStepItem.GoodsDataList[i].GCount,
                            newStepItem.GoodsDataList[i].Quality, "", newStepItem.GoodsDataList[i].Forge_level,
                            newStepItem.GoodsDataList[i].Binding, 0, "", true, 1, "升级有礼奖品", Global.ConstGoodsEndTime, newStepItem.GoodsDataList[i].AddPropIndex,
                            newStepItem.GoodsDataList[i].BornIndex, newStepItem.GoodsDataList[i].Lucky, newStepItem.GoodsDataList[i].Strong, newStepItem.GoodsDataList[i].ExcellenceInfo, newStepItem.GoodsDataList[i].AppendPropLev);
                    }
                }
                else
                {
        ...
        public static int ProcessGetBigAwardGift(GameClient client, int bigAwardID, int whichOne)
        {
            ...
            if (subGiftJiFen > 0)
            {
                ...
                string[] fields = Global.ExecuteDBCmd((int)TCPGameServerCmds.CMD_DB_SUBCHONGZHIJIFEN, strcmd);
            ...
            for (int i = 0; i < goodsDataList.Count; i++)
            {
                ...
                Global.AddGoodsDBCommand(Global._TCPManager.TcpOutPacketPool, client,
                    ...
                    goodsDataList[i].Binding, 0, "", true, 1, "充值有礼", Global.ConstGoodsEndTime, goodsDataList[i].AddPropIndex, goodsDataList[i].BornIndex, goodsDataList[i].Lucky, goodsDataList[i].Strong);
            }
        ...
        public static int ProcessGetSongLiGift(GameClient client, int songLiID, string liPinMa)
        {
            ...
            if (songLiItem.IsNeedCode > 0)
            {
                ...
                fields = Global.ExecuteDBCmd((int)TCPGameServerCmds.CMD_DB_GETLIPINMAINFO, strcmd);
                if (null == fields || fields.Length < 2)
                {
                    return -200;
                }
            ...
            if (songLiItem.IsNeedCode > 0)
            {
                ...
                strcmd = string.Format("{0}:{1}:{2}", client.ClientData.RoleID, songLiID, liPinMa);
                fields = Global.ExecuteDBCmd((int)TCPGameServerCmds.CMD_DB_USELIPINMA, strcmd);
                if (null == fields || fields.Length < 2)
                {
                    return -200;
                }
        ...
        public static int ProcessGetLimitTimeLoginGift(GameClient client, int whichOne)
        {
            ...
            for (int i = 0; i < limitTimeLoginItem.GoodsDataList.Count; i++)
            {
                ...
                //添加物品
                Global.AddGoodsDBCommand(Global._TCPManager.TcpOutPacketPool, client,
                    limitTimeLoginItem.GoodsDataList[i].GoodsID, limitTimeLoginItem.GoodsDataList[i].GCount,
                    limitTimeLoginItem.GoodsDataList[i].Quality, "", limitTimeLoginItem.GoodsDataList[i].Forge_level,
                    limitTimeLoginItem.GoodsDataList[i].Binding, 0, "", true, 1, "限时累计登录奖励", Global.ConstGoodsEndTime, limitTimeLoginItem.GoodsDataList[i].AddPropIndex, limitTimeLoginItem.GoodsDataList[i].BornIndex, limitTimeLoginItem.GoodsDataList[i].Lucky, limitTimeLoginItem.GoodsDataList[i].Strong);
            }
      ...
      public static void ReadAwardConfig(XElement args, out Dictionary<int, AwardItem> AwardDict,out Dictionary<int, AwardItem> AwardDict2)
      {
        ...
        public static void ProcessUpLevelAward4_60Level_100Level(GameClient client, int oldLevel, int newLevel)
        {
            ...
            int elapsedDays = Global.GetDaysSpanNum(DateTime.Now, Global.GetRegTime(client.ClientData), false);
        ...
        public static void ProcessGetUpLevelAward4_60Level_100Level(GameClient client, int awardID)
        {
            ...
            if (null != client)
            {
                ...
                ret = GameManager.ClientMgr.AddUserGold(Global._TCPManager.MySocketListener, Global._TCPManager.tcpClientPool, Global._TCPManager.TcpOutPacketPool,
                     client, upLevelAwardItem.AwardYuanBao);
            }
        ...
        public static void ProcessGetKaiFuGiftAward()
        {
            ...
            if (ProcessKaiFuGiftAwardHour != DateTime.Now.Hour)
            {
                return;
            }
            ...
            {
                ret = GameManager.ClientMgr.AddUserMoney(Global._TCPManager.MySocketListener, Global._TCPManager.tcpClientPool, Global._TCPManager.TcpOutPacketPool,
                     client, kaiFuGiftItem.AwardYuanBao, "开服在线奖励");
            }
            else
            {
                ret = GameManager.ClientMgr.AddUserMoneyOffLine(Global._TCPManager.MySocketListener, Global._TCPManager.tcpClientPool, Global._TCPManager.TcpOutPacketPool,
                     roleID, kaiFuGiftItem.AwardYuanBao, "开服在线奖励", zoneID, Global.QueryUserMoneyFromDB(roleID, roleName));
            }
        ...
        /// 上一次写入的日期ID
        /// </summary>
        private static int LastAutoAddKaiFuGiftRoleNumDayID = (int)DateTime.Now.DayOfYear;
        ...
        public static void FixKaiFuOnlineAwardDataList(List<KaiFuOnlineAwardData> kaiFuOnlineAwardDataList, int dayID)
        {
            if (null != kaiFuOnlineAwardDataList)
            {
                ...
                if (!founded)
                {
                    //处理获奖
                    //从DBServer获取副本顺序ID
                    string[] dbFields = Global.ExecuteDBCmd((int)TCPGameServerCmds.CMD_DB_QUERYKAIFUONLINEAWARDROLEID, string.Format("{0}", dayID));
                    if (null != dbFields && dbFields.Length >= 4)
                    {
                        int totalRoleNum = Global.SafeConvertToInt32(dbFields[3]);
        ...
        /// </summary>
        /// <param name="client"></param>
        public static void OnJieriRoleLogin(GameClient client, int preLoginDay)
        {
            int dayID = DateTime.Now.DayOfYear;
            if (dayID == preLoginDay)
            {
            ...
            //DateTime endDay = Global.GetAddDaysDataTime(startDay, Global.GetJieriDaysNum());
            ...
            //if (today.Ticks < startDay.Ticks || today.Ticks >= endDay.Ticks) //如果不是在假期，则重置为0，退出
            ...
            else
            {
                ...
                if (preDay == preLoginDay)
                {
                    ...
                    if (startDay.DayOfYear == jieriLoginDayID) //防止节日活动连续开启时的错误
                    {
                        //连续登录
                        jieriLoginNum++;
                    }
            ...
            Global.SaveRoleParamsInt32ValueToDB(client, RoleParamName.JieriLoginDayID, startDay.DayOfYear, true);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static void LoadJieriActivitiesConfig()
        {
            JieriActivityConfig config = HuodongCachingMgr.GetJieriActivityConfig();
            {
                if (null == config)
                {
                    throw new Exception("节日活动开启配置项出错");
                }
            }
                    ...
                    foreach (var xmlItem in xmlItems)
                    {
                        if (null != xmlItem)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    //将物品字符串列表解析成物品数据列表
                                    myAwardItem.GoodsDataList = ParseGoodsDataList(fields, "大型节日充值王活动配置2");
                                }
                            }
            ...
            try
            {
                ...
                if (null != args)
                {
                    ...
                    if (null != xmlItem)
                    {
                        ...
                        activity.AwardDict[(int)HeFuLoginAwardType.VIPAward] = NormalAward;
                    }
        ...
        public static HeFuPKKingActivity GetHeFuPKKingActivity()
        {
            ...
            try
            {
                ...
                activity.FromDate = Global.GetHuoDongTimeByHeFu(0, 0, 0, 0);
                activity.ToDate = Global.GetHuoDongTimeByHeFu(ActivityTime - 1, 23, 59, 59);
                activity.AwardStartDate = Global.GetHuoDongTimeByHeFu(activity.winerCount + 1, 0, 0, 0);
                activity.AwardEndDate = Global.GetHuoDongTimeByHeFu(AwardTime - 1, 23, 59, 59);
        ...
        public static int GetHeFuWCKingBHID()
        {
            ...
            if (DateTime.Now >= startAward && DateTime.Now <= endAward)
            {
            ...
            if (DateTime.Now >= startAward && DateTime.Now <= endAward)
            {
                ...
                if (hefuWCKingNum < 3)
                {
                    ...
                    if (dayID != hefuWCKingDayID) //同一天，只能设置一次
                    {
                        ...
                        Global.UpdateDBGameConfigg("hefuwcking", hefuWCKingBHID.ToString());
                        Global.UpdateDBGameConfigg("hefuwckingdayid", hefuWCKingDayID.ToString());
                        Global.UpdateDBGameConfigg("hefuwckingnum", hefuWCKingNum.ToString());
                    }
                }
            }
            else //如果不在合服活动时间内
            {
                Global.UpdateDBGameConfigg("hefuwckingnum", "0"); //置零，防止下次活动时，无法进入
            }
        }
        ...
        {
            string fileName = "Config/RiChangGifts/DayChongZhi.xml";
            GeneralCachingXmlMgr.RemoveCachingXml(Global.GameResPath(fileName));
        ...
        {
            string fileName = "Config/RiChangGifts/MuLevel.xml";
            GeneralCachingXmlMgr.RemoveCachingXml(Global.GameResPath(fileName));
