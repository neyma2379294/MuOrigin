...
namespace GameServer.Logic
{
    ...
    public class LuaManager
    {
        ...
        /// <returns></returns>
        public Boolean CallMonstersForGameClient(GameClient client, int monsterID, int callAsType = (int)MonsterTypes.DSPetMonster, int callNum = 1)
        {
        ...
        {
            GameManager.ClientMgr.AddUserGoldOffLine(Global._TCPManager.MySocketListener, Global._TCPManager.tcpClientPool, Global._TCPManager.TcpOutPacketPool, client.ClientData.RoleID, gold, "LUA脚本");
        }
