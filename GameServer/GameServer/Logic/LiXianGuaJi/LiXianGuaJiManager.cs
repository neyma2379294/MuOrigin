    ...
    public class LiXianGuaJiManager : ScheduleTask, IManager
    {
        ...
        public static void SaveDBLiXianGuaJiTimeForRole(LiXianGuaJiRoleItem liXianGuaJiRoleItem)
        {
            GameManager.DBCmdMgr.AddDBCmd((int)TCPGameServerCmds.CMD_DB_UPDATEROLEPARAM,
                string.Format("{0}:{1}:{2}", liXianGuaJiRoleItem.RoleID, RoleParamName.MeditateTime, liXianGuaJiRoleItem.MeditateTime), null);
            GameManager.DBCmdMgr.AddDBCmd((int)TCPGameServerCmds.CMD_DB_UPDATEROLEPARAM,
                string.Format("{0}:{1}:{2}", liXianGuaJiRoleItem.RoleID, RoleParamName.NotSafeMeditateTime, liXianGuaJiRoleItem.NotSafeMeditateTime), null);
        }
