...
namespace GameServer.Logic
{
    public class MonsterMoving
    {
        ...
        public bool _LinearMove(Monster sprite, Point p, int action)
        {
            ...
            {
                string warning = String.Format("_LinearMove 消耗:{0}毫秒, start({1}, {2}), to({3}, {4}), mapID={5}", ticks2 - ticks1,
                    sprite.Coordinate.X, sprite.Coordinate.Y, p.X, p.Y, sprite.MonsterZoneNode.MapCode);
