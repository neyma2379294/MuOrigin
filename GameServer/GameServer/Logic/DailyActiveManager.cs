...
namespace GameServer.Logic
{
    ...
    public class DailyActiveManager
    {
        ...
        public static void InitDailyActiveFlagIndex()
        {
            ...
            //m_DailyActiveDayID = (int)DateTime.Now.DayOfYear;
        }
        ...
        public static void UpdateDailyActiveAwardFlag(GameClient client, int nID)
        {
            ...
            Global.SaveRoleParamsInt32ValueToDB(client, RoleParamName.DailyActiveAwardFlag, n, false);
        }
        ...
        public static void ProcessLoginForDailyActive(GameClient client, out bool bIsCompleted)
        {
            ...
            //int nToday = (int)DateTime.Now.DayOfYear;
        ...
        /// </summary>
        /// <returns></returns>
        public static void ProcessCompleteCopyMapForDailyActive(GameClient client, int nCopyMapLev)
        {
...
//             }
        ...
        public static void CleanDailyActiveInfo(GameClient client)
        {
            ...
            Global.SaveRoleParamsInt32ValueToDB(client, RoleParamName.DailyActiveAwardFlag, 0, false);
